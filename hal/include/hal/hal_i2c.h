 ...
 */
typedef void (*hal_i2c_callback_t)(hal_i2c_instance_t instance,
                                   uint32_t event,
                                   void* context);
 ...
 * \return          HAL_OK on success, error code otherwise
 */
hal_status_t hal_i2c_mem_write(hal_i2c_instance_t instance,
                               uint16_t dev_addr,
                               uint16_t mem_addr,
 ...
 * \return          HAL_OK on success, error code otherwise
 */
hal_status_t hal_i2c_mem_read(hal_i2c_instance_t instance,
                              uint16_t dev_addr,
                              uint16_t mem_addr,
                              uint8_t mem_addr_size,
                              uint8_t* data,
