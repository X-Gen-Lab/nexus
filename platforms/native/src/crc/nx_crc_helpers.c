 ...
 *
 * \details         Implements CRC-32 (IEEE 802.3) and CRC-16 (CCITT)
 *                  algorithms for software CRC calculation.
 */
...
/**
 * \brief           CRC-32 lookup table
 * \details         Polynomial: 0x04C11DB7 (Ethernet, ZIP, PNG)
 */
 ...
 * \details         Polynomial: 0x1021 (X.25, HDLC, Bluetooth)
 */
