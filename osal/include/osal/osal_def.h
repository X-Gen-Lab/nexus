...
typedef enum {
    ...
    OSAL_ERROR_BUSY         = 6,    /**< Resource busy */
    OSAL_ERROR_NOT_FOUND    = 7,    /**< Resource not found */
    OSAL_ERROR_FULL         = 8,    /**< Queue/buffer full */
    OSAL_ERROR_EMPTY        = 9,    /**< Queue/buffer empty */
    OSAL_ERROR_ISR          = 10,   /**< Called from ISR context */
} osal_status_t;
