...
TRANSFER_MODE_PERIPHERALS = [
    ...
    ('PLATFORM_STM32', 'INSTANCE_STM32_UART_1', 'STM32_UART1', 'UART1'),
    ('PLATFORM_STM32', 'INSTANCE_STM32_UART_2', 'STM32_UART2', 'UART2'),
    ('PLATFORM_STM32', 'INSTANCE_STM32_UART_3', 'STM32_UART3', 'UART3'),
    # Native UART instances
    ('PLATFORM_NATIVE', 'INSTANCE_NATIVE_UART_0', 'NATIVE_UART0', 'UART0'),
    ('PLATFORM_NATIVE', 'INSTANCE_NATIVE_UART_1', 'NATIVE_UART1', 'UART1'),
    ('PLATFORM_NATIVE', 'INSTANCE_NATIVE_UART_2', 'NATIVE_UART2', 'UART2'),
    ('PLATFORM_NATIVE', 'INSTANCE_NATIVE_UART_3', 'NATIVE_UART3', 'UART3'),
]
