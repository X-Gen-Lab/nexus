...
BUFFERED_PERIPHERALS = [
    ...
    ('PLATFORM_STM32', 'INSTANCE_NX_UART_1', 'UART1'),
    ('PLATFORM_STM32', 'INSTANCE_NX_UART_2', 'UART2'),
    ('PLATFORM_STM32', 'INSTANCE_NX_UART_3', 'UART3'),
    # Native UART instances
    ('PLATFORM_NATIVE', 'INSTANCE_NX_UART_0', 'UART0'),
    ('PLATFORM_NATIVE', 'INSTANCE_NX_UART_1', 'UART1'),
    ('PLATFORM_NATIVE', 'INSTANCE_NX_UART_2', 'UART2'),
    ('PLATFORM_NATIVE', 'INSTANCE_NX_UART_3', 'UART3'),
